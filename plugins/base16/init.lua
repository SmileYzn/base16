...
local function base16_apply_colors(base16)
  ...
  style.accent      = {common.color(base16["base08"])} -- Accent Color
  ...
  style.line_number2     = {common.color(base16["base08"])} -- With cursor (Current line color)
  ...
  style.scrollbar2       = {common.color(base16["base08"])} -- Hovered color
  style.scrollbar_track  = {common.color(base16["base01"])} -- Scroolbar free space color
  --
  -- Notification Bar
  style.nagbar           = {common.color(base16["base08"])} -- Background color
  ...
  style.drag_overlay_tab = {common.color(base16["base08"])} -- Left color when drag tab with mouse cursor
  --
  -- Console Icon Colors
